...
CREATE POLICY "Allow all operation for auth users" ON "public"."order" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Enable Insert for authenticated user only" ON "public"."category" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "users"."type"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())) = 'ADMIN'::"text"));



CREATE POLICY "Enable Read Access of all users" ON "public"."users" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Enable Update for  Auth User" ON "public"."product" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Enable delete for Admin User only" ON "public"."product" FOR DELETE TO "authenticated" USING ((( SELECT "users"."type"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())) = 'ADMIN'::"text"));
...
CREATE POLICY "Enable read access of all users" ON "public"."product" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Enable update of Admins Only" ON "public"."category" FOR UPDATE TO "authenticated" USING ((( SELECT "users"."type"
   FROM "public"."users"
...
CREATE POLICY "allow all operation for auth user " ON "public"."order_item" TO "authenticated" USING (true) WITH CHECK (true);
